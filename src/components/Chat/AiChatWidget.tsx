...
const AiChatWidget: React.FC = () => {
  ...
  const generateBotResponse = (userMessage: string): string => {
    ...
    if (lowerMessage.includes('return') || lowerMessage.includes('profit')) {
      return 'You receive 50% of the net profit from milk sales. Average returns range from 25-40% annually. Returns depend on milk yield, market prices, and operational efficiency.';
    }

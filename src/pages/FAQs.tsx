...
const FAQs: React.FC = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'Historical returns have ranged from 25-40% annually, with an average of 15%. Returns depend on milk yield, market prices, and operational efficiency. We provide transparent reporting so you can track performance in real-time.'
    },
    {
      id: 12,
      category: 'returns',
